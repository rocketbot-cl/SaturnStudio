...
|Parameters|Description|example|
| --- | --- | --- |
|Data Store ID|ID of the Data Store where the record will be updated in your Saturn Studio account|e88d5dfd3c59f0f5fbb908d0f6aaf7ab|
|Record ID|ID of the record to update in the Data Store in your Saturn Studio account|bb24f3e07b147d16ba3ca9b25b181695|
|New data (JSON format)|New data that will overwrite the record. The record will be updated with the provided values.|{
  "name": "John",
  "age": 31
}|
|Assign result to variable|Variable where the updated record information in your Saturn Studio account will be stored|Variable|
